...
export default function ContactForm() {
	...
	if (done) {
		return (
			<div className="card-x p-8 text-center" role="status" aria-live="polite">
				...
				<h3 className="font-display text-[19px] font-extrabold text-navy">
					Message captured — ref {done.ref}
				</h3>
				<p className="mx-auto mt-2 max-w-sm text-[13.5px] leading-relaxed text-muted">
					For time-sensitive requirements please also reach us via the contact
	...
	return (
		...
		>
			...
			<div className="grid gap-x-5 gap-y-4 sm:grid-cols-2">
				...
				>
					<TextArea
						...
						placeholder="Briefly describe what you need — trade, volume, destination — and we route it to the right desk."
					/>
				</Field>
				<div className="sm:col-span-2">
					...
					>
						I consent to Sanska International contacting me about this enquiry
						per the{" "}
						<a
							href="/privacy"
			...
			<button
				type="submit"
				className="btn-navy mt-6 w-full sm:w-auto"
				disabled={sending}
			>
